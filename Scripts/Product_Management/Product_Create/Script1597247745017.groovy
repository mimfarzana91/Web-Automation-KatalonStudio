...
WebUI.delay(04)
WebUI.click(findTestObject('Object Repository/Product_management/Page_SxTvappAdmin/a_(EC)_Product'))
WebUI.delay(04)
WebUI.click(findTestObject('Object Repository/Product_management/Page_SxTvappAdmin/add_button'))
WebUI.delay(03)
CustomKeywords.'product_management.product_create.uiVerification'()
CustomKeywords.'product_management.product_create.alertMsgVerification'()
CustomKeywords.'product_management.product_create.imageFileVerification'()
...
WebUI.click(findTestObject('Object Repository/Product_management/Page_SxTvappAdmin/add_button'))
WebUI.delay(03)
WebUI.scrollToElement(findTestObject('Object Repository/Product_management/Page_SxTvappAdmin/button_register'), 0)
...
WebUI.click(findTestObject('Object Repository/Product_management/Page_SxTvappAdmin/add_button'))
WebUI.delay(03)
CustomKeywords.'product_management.product_create.productCreate'()
