...
WebUI.click(findTestObject('Object Repository/Present_management/verify_UI/present_sidebar'))
WebUI.delay(5)

WebUI.click(findTestObject('Object Repository/Present_management/verify_UI/Edit_btn'))
CustomKeywords.'present_management.present_create.VerifyPresentEditPageUI'()
WebUI.delay(4)

CustomKeywords.'present_management.present_create.verifypresentUpdate'()
WebUI.delay(4)
...
WebUI.click(findTestObject('Object Repository/Present_management/EditUI/sidebar'))
WebUI.delay(3)
WebUI.click(findTestObject('Object Repository/Present_management/EditUI/edit_btn'))
WebUI.delay(2)
